...
function yith_ajax_search_constructor() {
    ...
    $loaded_yith_ajax=load_textdomain( 'yit',dirname( plugin_dir_path( __FILE__ ) ). '/yith-woocommerce-ajax-search/languages/yit-es_CL.mo' );

    if(!$loaded_yith_ajax){
        echo dirname( plugin_dir_path( __FILE__ ) ). '/yith-woocommerce-ajax-search/languages/yit-es_CL.mo';
        exit();
    }
