...
function yith_wishlist_constructor() {
    ...
    $loaded_yit = load_textdomain( 'yit', dirname( plugin_dir_path( __FILE__ ) ). '/yith-woocommerce-wishlist/languages/yit-es_CL.mo' );

    // if(!$loaded_yit){
    //     echo dirname( plugin_dir_path( __FILE__ ) ). '/yith-woocommerce-wishlist/languages/yit-es_CL.mo';
    //     exit();
    // }
