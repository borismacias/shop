...
function flatsome_setup() {
	...
	// load_theme_textdomain( 'es_CL', get_template_directory() . '/languages' );

	$loaded_es_cl = load_textdomain( 'es_CL', get_template_directory().'/languages/es_CL.mo');
	$loaded_woo = load_textdomain( 'woocommerce', get_template_directory() . '/languages/woocommerce-es_CL.mo' );
	$loaded_flat = load_textdomain( 'flatsome', get_template_directory() . '/languages/flatsome.mo' );
