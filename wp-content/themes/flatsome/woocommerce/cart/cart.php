...
<div class="cart-sidebar">
	...
	<input type="submit" class="checkout-button secondary expand button" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'es_CL' ); ?>" />
	...
	<?php $woocommerce->nonce_field('cart') ?>
		...
		<div class="coupon">
			...
			<input type="text" name="coupon_code"  id="coupon_code" value="" placeholder="<?php _e( 'Enter Coupon', 'es_CL' ); ?>"/> 
